...
export default function Entries({ list }) {
  return (
    <div>
      <div
        className="pb-6 pt-8 bg-blue-400 p-5"
        id="blacklist"
        onDragOver={(e) => {
          e.preventDefault();
        }}
      >
        ...
        <ul className="font-sans font-light p-6 text-2xl text-center transition-colors  p-6">
      ...
      <div
        className="p-6 bg-blue-400 p-5"
        id="whitelist"
        onDragOver={(e) => {
          e.preventDefault();
        }}
      >
        <h1 className="font-sans font-light p-6 text-3xl text-center transition-colors  p-6">
          Whitelist
        </h1>
        <ul className="font-sans font-light p-6 text-2xl text-center transition-colors  p-6">

...
export default function Search({filter, setFilter}) {
  ...
  useEffect(() => {
    if (JSON.stringify(simpleFilter) !== JSON.stringify({
      blacklist: {},
      whitelist: {},
      true_blacklist: {},
      user_flip_finder: {}
  ...
  >
    ...
    {filter == null && !ignoreLoaded && (
      <div
        className={"bg-[#273b30] rounded mx-auto my-5 w-fit fixed flex bottom-0 left-0 right-0 justify-items-center justify-self-center self-center"}>
        <button
